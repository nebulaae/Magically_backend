...
router.post('/', auth, asyncHandler(paymentController.createPayment));
...
router.get('/me', auth, asyncHandler(paymentController.getMyPayments));
...
router.get('/currency', asyncHandler(currencyController.getCurrency));
...
router.get('/:paymentId', auth, asyncHandler(paymentController.getPaymentById));
