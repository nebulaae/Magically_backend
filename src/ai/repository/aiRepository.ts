...
// CRUD для моделей
export const createModel = (data: Partial<TrainingModel>, transaction?: Transaction) => {
...
export const updateModel = (model: TrainingModel, data: Partial<TrainingModel>, transaction?: Transaction) => {
    return model.update(data, { transaction });
};

export const deleteModel = (model: TrainingModel, transaction?: Transaction) => {
