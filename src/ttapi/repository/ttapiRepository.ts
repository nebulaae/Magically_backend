...
export const createModel = (data: Partial<TtModel>, transaction?: Transaction) => {
...
export const updateModel = (model: TtModel, data: Partial<TtModel>, transaction?: Transaction) => {
