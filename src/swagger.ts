...
const BACKEND_URL =
  process.env.BACKEND_URL || 'https://monkfish-upright-lamb.ngrok-free.app';
    ...
    schemas: {
      ...
      Publication: {
        ...
        properties: {
          ...
          isFollowing: {
            type: 'boolean',
            description: 'Подписан ли текущий пользователь на автора',
          },
  ...
  paths: {
    ...
    '/users/me/profile/followers': {
      get: {
        ...
        responses: { '200': { description: 'Список подписчиков' } },
      },
    },
    ...
    '/users/users/recommendations': {
      get: {
        ...
        responses: {
          '200': { description: 'Список рекомендованных пользователей' },
        },
      },
    },
    '/users/me/admin': {
      put: {
        tags: ['Users'],
        summary: 'Стать админом (dev)',
        responses: { '200': { description: 'Роль изменена' } },
      },
    },
    '/users/{username}': {
      get: {
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            in: 'query',
            name: 'sortBy',
            schema: { type: 'string', enum: ['newest', 'popular', 'oldest'] },
          },
    ...
    '/publications/{publicationId}/like': {
      post: {
        ...
        responses: { '200': { description: 'Лайк поставлен' } },
      },
    },
    '/publications/{publicationId}/unlike': {
      delete: {
        ...
        responses: { '200': { description: 'Лайк убран' } },
      },
    },
    ...
    '/comments/{commentId}/reply': {
      post: {
        ...
        responses: { '201': { description: 'Ответ создан' } },
      },
    },
    '/comments/{commentId}': {
      put: {
    ...
    '/comments/{commentId}/like': {
      post: {
        ...
        responses: { '200': { description: 'Лайк' } },
      },
    },
    '/comments/{commentId}/unlike': {
      delete: {
        ...
        responses: { '200': { description: 'Лайк удален' } },
      },
    },
              ...
              schema: {
                ...
                properties: {
                  ...
                  nanoImage: {
                    type: 'string',
                    format: 'binary',
                    description: 'Image to Image reference',
                  },
                },
              },
            },
              ...
              schema: {
                ...
                properties: {
                  higgsfieldImage: {
                    ...
                    description: 'Start (and optional End) frame',
                  },
                  prompt: { type: 'string' },
                  motion_id: { type: 'string' },
                  model: {
                    type: 'string',
                    enum: ['turbo', 'standard', 'lite'],
                  },
        ...
        requestBody: {
          content: {
            'application/json': {
              schema: {
                type: 'object',
                required: ['modelDestination', 'prompt'],
                properties: {
                  modelDestination: { type: 'string' },
                  prompt: { type: 'string' },
    ...
    '/admin/users/{userId}/block': {
      put: {
        tags: ['Admin'],
        summary: 'Блокировать пользователя',
        parameters: [
          {
            in: 'path',
            name: 'userId',
        ...
        responses: { '200': { description: 'Заблокирован' } },
      },
    },
    '/admin/users/{userId}/unblock': {
      put: {
        ...
        responses: { '200': { description: 'Разблокирован' } },
      },
    },
    '/admin/publications/{publicationId}': {
      delete: {
        tags: ['Admin'],
        summary: 'Удалить любую публикацию',
        parameters: [
          {
            in: 'path',
            name: 'publicationId',
